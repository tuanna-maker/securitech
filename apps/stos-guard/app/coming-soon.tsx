...
export default function ComingSoonScreen() {
  ...
  return (
    <Screen title={title || "Sắp ra mắt"} subtitle={subtitle}>
      <View style={styles.center}>
        <View style={[styles.icon, { backgroundColor: brand.navy + "44" }]}>
          <StosIcon name="construct" size={40} color={brand.techCyan} />
        </View>
        <Text style={[textStyle("body"), { color: colors.textSecondary, textAlign: "center", marginTop: spacing.lg }]}>
          Tính năng đang hoàn thiện. Giao diện theo mockup — nghiệp vụ bổ sung sau.
        </Text>
