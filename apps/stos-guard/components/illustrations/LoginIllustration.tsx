  ...
  return (
    <View style={styles.wrap} accessibilityIgnoresInvertColors>
      <Svg width={280} height={160} viewBox="0 0 280 160">
        ...
        <Path d="M200 78 L210 88 L200 112 L190 88 Z" fill="#fff" transform="translate(0, 4)" />
...
const styles = StyleSheet.create({ wrap: { alignItems: "center", justifyContent: "center", paddingVertical: 8 } });
